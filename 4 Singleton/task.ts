...
class FordFactory implements CarFactory {
  private static Factory: FordFactory;

  public static get factory(): FordFactory {
    if (!FordFactory.Factory) {
      FordFactory.Factory = new FordFactory();
    }
    return FordFactory.Factory;
  }
...
const fordCarFactory = FordFactory.factory;
